...
```{r clean-ns-data}
ns_joined <- readRDS("ns_joined.RDS")
...
```{r clean-nyt}
nyt_police <- readRDS("nyt_police.RDS")
...
```{r nyt-sentiment-viz}
nyt_sentiment <- readRDS("nyt_sentiment.RDS")
...
```{r ns-viz}
ns_nyt_joined <- readRDS("ns_nyt_joined.RDS")
